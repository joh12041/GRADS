...
/**
 * MasterC.java - Class containing all graduation requirements for students
 * pursuing a Master's degree on Plan C. Also included is a mechanism to access
...
public class MasterC {
    ...
    /**
     * getReqList() - Method for getting the requirements list for Master Plan C
     *
     * @return reqList - Return the list of all requirements for graduation for Master Plan C
     */
