...
/**
 * InvalidStudentListException.java - Class containing exception wrapper
 * 
...
public class InvalidStudentListException extends Exception{
	...
	/**
     * InvalidStudentListException() - Method for wrapping an exception in a higher level exception
     * 
     ...
     */
    public InvalidStudentListException(String message, Throwable t){
        super(message, t);
    }
     ...
     * @param t - A variable of type Throwable identifying the previous exception
     */
    public InvalidStudentListException(Throwable t){
        super(t);
    }
