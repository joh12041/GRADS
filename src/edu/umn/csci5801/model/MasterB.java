...
/**
 * MasterB.java - Class containing all graduation requirements for students
 * pursuing a Master's degree on Plan B. Also included is a mechanism to access
...
public class MasterB {
     ...
     *
     * @return reqList - Return the list of all requirements for graduation for Master Plan B
     */
